...
def get_topology() -> dict[str, Any]:
    ...
    """
    return topology_mod.get_topology(_CONFIG)
...
def list_infra_datasets() -> dict[str, Any]:
    ...
    """
    return infra_datasets.list_datasets(_CONFIG)
...
def get_infra_dataset(dataset_id: str, refresh: bool = False) -> dict[str, Any]:
    ...
    """
    return infra_datasets.read_dataset(_CONFIG, dataset_id, refresh=refresh)
